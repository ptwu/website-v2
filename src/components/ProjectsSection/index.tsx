          ...
          <Grid className={styles.fullwidthGrid} container justify="center" spacing={8}>
            ...
            <Grid item xs>
              <Project
                ...
                desc="Dealing with the isolation of the pandemic in the spring of 2020, I made this multiplayer web game which implements a classic poker game to play with friends and family. Built with socket.io and Node.js, and Express."
